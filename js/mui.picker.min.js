...
! function(e, t, i, n) {
	...
	p.prototype.findElementItems = function() {
		...
		e && (t.items = []), t.elementItems.forEach(function(i) {
			...
			if(t.endAngle = t.itemAngle * n, i.angle = t.endAngle, i.style.webkitTransformOrigin = "center center -" + t.r + "px", i.style.webkitTransform = "translateZ(" + t.r + "px) rotateX(" + -t.endAngle*dpr + "deg)", e) {
				var a = {};
		...
		var t = this;
		t.list.angle = e, t.list.style.webkitTransform = "perspective(1000px) rotateY(0deg) rotateX(" + e*dpr + "deg)", t.calcElementItemVisibility(e)
